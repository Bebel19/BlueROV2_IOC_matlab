classdef ROVSimulator0x2D2App < handle
    %
    % Usage:
    %     app.ROVSimulator0x2D2App
    ...
    properties (Constant)
        AppPathBase = {'/ROVSimulator - 2'};
        AppClass = 'ROVSimulator0x2D2App';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = ROVSimulator0x2D2App()
        ...
        function startApp(obj)
            ...
            mlock;
            ROVSimulator0x2D2App.refcount(obj.Increment);
