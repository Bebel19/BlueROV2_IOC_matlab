classdef ROVSimulator2024aApp < handle
    %
    % Usage:
    %     app.ROVSimulator2024aApp
    ...
    properties (Constant)
        AppPathBase = {'/ROVSimulator2024a'};
        AppClass = 'ROVSimulator2024aApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = ROVSimulator2024aApp()
        ...
        function startApp(obj)
            ...
            mlock;
            ROVSimulator2024aApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'ROV_App')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong ROV_App
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'ROV_App').getString, ...
            ...
            if nargout(@ROV_App) == 0
                eval('ROV_App');
            else
                obj.AppHandle = eval('ROV_App');
            end
